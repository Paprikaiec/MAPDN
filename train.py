...
parser.add_argument("--scenario", type=str, nargs="?", default="bus33_3min_final",
...
assert net_topology in ['case33_3min_final', 'case141_3min_final', 'case322_3min_final',
						'120agents_case33'], f'{net_topology} is not a valid scenario.'
if argv.scenario == 'case33_3min_final' or '120agents_case33':
...
assert argv.mode in ['distributed',
					 'decentralised'], "Please input the correct mode, e.g. distributed or decentralised."
...
# use wandb
run = wandb.init(project="var_voltage_control",
				 entity="wangyiwen",
				 config={**env_config_dict, **alg_config_dict},
				 name='+'.join((argv.alg, argv.scenario, argv.voltage_barrier_type)))
